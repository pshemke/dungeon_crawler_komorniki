class blue_slime extends Mob{
  blue_slime(int x,int y){
    this.x = x;
    this.y = y;
    this.hp = 15;
    this.attack = 2;
    this.name = "Blue Slime";
    this.desc = "Stronger than his brother :(";
    this.icon = slimeblue.get(0,0,32,32);

  }

  Mob make_copy(int new_x, int new_y){return new blue_slime(new_x,new_y); };
